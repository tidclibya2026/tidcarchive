...
- [x] Diagnose and repair the GitHub Pages 404 for the tidcarchive repository without exposing production secrets or changing local hosting.
- [x] Publish a safe static GitHub Pages landing page under docs with an index.html entry point and instructions for the full TIDC system.
